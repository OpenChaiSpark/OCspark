#include <string.h>
#include "includes/com_pointr_tensorflow_api_PcieDMAServer.h"
...
/*
 * Class:     com_pointr_tensorflow_api_PcieDMAServer
 * Method:    setupChannelN
 * Signature: (Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAServer_setupChannelN
 ...
 */
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAServer_registerN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
...
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAServer_prepareWriteN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
 ...
 */
JNIEXPORT jobject JNICALL Java_com_pointr_tensorflow_api_PcieDMAServer_writeN
...
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAServer_completeWriteN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
...
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAServer_prepareReadN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
 ...
 */
JNIEXPORT jobject JNICALL Java_com_pointr_tensorflow_api_PcieDMAServer_readN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeObject(env, str, fname));
...
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAServer_completeReadN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
 ...
 * Signature: (Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAServer_shutdownChannelN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
 ...
 * Signature: ([B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_pointr_tensorflow_api_PcieDMAServer_readLocalN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
