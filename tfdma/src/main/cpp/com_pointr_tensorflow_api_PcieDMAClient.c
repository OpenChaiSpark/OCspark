#include <string.h>
#include "includes/com_pointr_tensorflow_api_PcieDMAClient.h"
...
/*
 * Class:     com_pointr_tensorflow_api_PcieDMAClient
 * Method:    setupChannelN
 * Signature: (Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAClient_setupChannelN
 ...
 * Signature: (Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAClient_prepareWriteN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
 ...
 */
JNIEXPORT jobject JNICALL Java_com_pointr_tensorflow_api_PcieDMAClient_writeN
 ...
 */
JNIEXPORT jobject JNICALL Java_com_pointr_tensorflow_api_PcieDMAClient_completeWriteN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
 ...
 * Signature: (Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAClient_prepareReadN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
 ...
 */
JNIEXPORT jobject JNICALL Java_com_pointr_tensorflow_api_PcieDMAClient_readN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeObject(env, str, fname));
 ...
 * Signature: (Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAClient_completeReadN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
 ...
 * Signature: (Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_pointr_tensorflow_api_PcieDMAClient_shutdownChannelN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
 ...
 * Signature: ([B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_pointr_tensorflow_api_PcieDMAClient_readLocalN
  (JNIEnv *env, jobject jobj, jstring str) {
  char fname[100];
  sprintf(fname, "%s", __func__);
  return(makeMsg(env, str, fname));
