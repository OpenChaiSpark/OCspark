...
import com.pointr.tensorflow.DirectSubmitter.ThreadResult
import com.pointr.tensorflow.GpuClient.{GpuClientInfo, ImgInfo}

object GpuStreaming extends GpuLogger {
